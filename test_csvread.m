%fileID = fopen('./Downloads/Ground_Truth_and_Results_Source_Normalized - Sheet1.csv');
fileID = fopen('./Downloads/Ground_Truth_and_Results_Source_Normalized_and_Unnormalized - Sheet1.csv');
